<html><head> 
				...
				<title>Cyber Intelligence - OSINT EMAIL</title><link rel="stylesheet" href="https://bootstrapstudio.io/demo//embed//bootstrap/4/default/bootstrap.min.css">
...
</style><style></style><style bs-system-element="" bs-hidden="">
...
<center>
<br>	
<h2>Cyber Intelligece - EMAIL OSINT </h2>
...
$organizacao=addslashes($_POST['org']);
$i=0;
...
if ($json = file_get_contents("https://api.hunter.io/v2/domain-search?domain=".$organizacao."&api_key=003e2c1d2fc39b40739574158e4d2cf3755b00ee",false,stream_context_create($stream_opts))){
$json2 = json_decode($json,true);


foreach ($json2["data"]["emails"] as $valor){
            $i++;
            $email =$valor['value'];
            $nome = $valor['first_name'];
...
echo "<script>document.location='http://localhost/Email'</script>";
